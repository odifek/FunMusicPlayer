...
import com.techbeloved.funmusicplayer.BuildConfig;
...
static {
    createMetadataCompat(
            ...
            214,
            TimeUnit.SECONDS,
            "chris_tomlin_medley_final.mp3",
            R.drawable.chris_tomlin_medley_art,
            "chris_tomlin_medley_art"
    );
    ...
    public static MediaMetadataCompat getMetadata(Context context, String mediaId) {
        ...
        // We don't need set it initially on all items so that they don't take unnecessary memory
    ...
    private static void createMetadataCompat(
            String mediaId,
            String title,
            String artist,
            String album,
