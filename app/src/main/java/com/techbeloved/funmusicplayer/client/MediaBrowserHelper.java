package com.techbeloved.funmusicplayer.client;
...
public class MediaBrowserHelper {
    ...
    /**
     * The internal state of the app need to revert to what it looks like when it is started before
     * any connections to the {@link com.techbeloved.funmusicplayer.service.MusicService} happens via the {@link android.support.v4.media.session.MediaSessionCompat}
     *
     */
    ...
    private class MediaControllerCallback extends MediaControllerCompat.Callback {
        ...
        // This might happen if the MusicService is killed while the Activity is in
        // the foreground and onStart() has been called (but not onStop())
