...
import com.techbeloved.funmusicplayer.service.PlaybackInfoListener;
import com.techbeloved.funmusicplayer.service.PlayerAdapter;
 ...
 */
public class LocalPlayback extends PlayerAdapter {
...
//    private final MusicProvider mMusicProvider;
    ...
    public LocalPlayback(Context context, PlaybackInfoListener listener) {
        super(context);
    ...
    private void initializeMediaPlayer() {
        if (mMediaPlayer == null) {
            ...
            mMediaPlayer.setOnCompletionListener(mediaPlayer -> {
                ...
                // Set the state to "paused" because it most closely matches the state in
                // MediaPlayer with regards to available state transitions compared to "stop".
    ...
    public void setVolume(float volume) {
        if (mMediaPlayer != null) {
            mMediaPlayer.setVolume(volume, volume); // Left and right
        }
    }
}
